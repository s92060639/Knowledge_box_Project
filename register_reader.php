...
<nav class="navbar">
    ...
    {
        $count = 0;
        $res = mysqli_query($conn, "select * from proof_reader where username='$_POST[username]'") or die(mysqli_error($conn));
        $res1 = mysqli_query($conn, "select * from proof_reader where email='$_POST[email]'") or die(mysqli_error($conn));
        ...
        if($count>0)
        {
            ...
            mysqli_query($conn, "insert into proof_reader values(NULL,'$_POST[firstname]','$_POST[lastname]','$_POST[username]','$_POST[password]','$_POST[email]','$_POST[contact]','0')")or die(mysqli_error($conn));
            ?>
